...
public class Types implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.types.Headers> headers;

    public java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.types.Headers> getHeaders() {
        return headers;
    }

    public void setHeaders(java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.types.Headers> headers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletspec.datatypes.types.Schema schema;

    public org.apache.camel.v1alpha1.kameletspec.datatypes.types.Schema getSchema() {
        return schema;
    }

    public void setSchema(org.apache.camel.v1alpha1.kameletspec.datatypes.types.Schema schema) {
        this.schema = schema;
    }
