...
public class StartupProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Exec exec;

    public org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Grpc grpc;

    public org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.HttpGet httpGet;

    public org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.TcpSocket tcpSocket;

    public org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(org.apache.camel.v1.integrationspec.template.spec.containers.startupprobe.TcpSocket tcpSocket) {
