...
public class KameletStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1alpha1.kameletstatus.Conditions> conditions;

    public java.util.List<org.apache.camel.v1alpha1.kameletstatus.Conditions> getConditions() {
        return conditions;
    }

    public void setConditions(java.util.List<org.apache.camel.v1alpha1.kameletstatus.Conditions> conditions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1alpha1.kameletstatus.Properties> properties;

    public java.util.List<org.apache.camel.v1alpha1.kameletstatus.Properties> getProperties() {
        return properties;
    }

    public void setProperties(java.util.List<org.apache.camel.v1alpha1.kameletstatus.Properties> properties) {
