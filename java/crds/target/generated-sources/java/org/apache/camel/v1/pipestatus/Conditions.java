...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.pipestatus.conditions.Pods> pods;

    public java.util.List<org.apache.camel.v1.pipestatus.conditions.Pods> getPods() {
        return pods;
    }

    public void setPods(java.util.List<org.apache.camel.v1.pipestatus.conditions.Pods> pods) {
        this.pods = pods;
    }
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Type of pipe condition.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private String type;
