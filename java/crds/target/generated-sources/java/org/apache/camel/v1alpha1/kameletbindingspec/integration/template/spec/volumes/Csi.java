...
public class Csi implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.csi.NodePublishSecretRef nodePublishSecretRef;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.csi.NodePublishSecretRef getNodePublishSecretRef() {
        return nodePublishSecretRef;
    }

    public void setNodePublishSecretRef(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.csi.NodePublishSecretRef nodePublishSecretRef) {
