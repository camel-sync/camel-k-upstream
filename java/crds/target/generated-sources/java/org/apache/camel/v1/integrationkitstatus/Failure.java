...
public class Failure implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationkitstatus.failure.Recovery recovery;

    public org.apache.camel.v1.integrationkitstatus.failure.Recovery getRecovery() {
        return recovery;
    }

    public void setRecovery(org.apache.camel.v1.integrationkitstatus.failure.Recovery recovery) {
