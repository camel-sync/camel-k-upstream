...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeLinuxOptions seLinuxOptions;

    public org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeccompProfile seccompProfile;

    public org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.Sysctls> sysctls;

    public java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.Sysctls> getSysctls() {
        return sysctls;
    }

    public void setSysctls(java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.Sysctls> sysctls) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.WindowsOptions windowsOptions;

    public org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(org.apache.camel.v1.pipespec.integration.template.spec.securitycontext.WindowsOptions windowsOptions) {
