...
public class KameletSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.DataTypes> dataTypes;

    public java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.DataTypes> getDataTypes() {
        return dataTypes;
    }

    public void setDataTypes(java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.DataTypes> dataTypes) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.kameletspec.Definition definition;

    public org.apache.camel.v1.kameletspec.Definition getDefinition() {
        return definition;
    }

    public void setDefinition(org.apache.camel.v1.kameletspec.Definition definition) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.kameletspec.Sources> sources;

    public java.util.List<org.apache.camel.v1.kameletspec.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<org.apache.camel.v1.kameletspec.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.kameletspec.Template template;

    public org.apache.camel.v1.kameletspec.Template getTemplate() {
        return template;
    }

    public void setTemplate(org.apache.camel.v1.kameletspec.Template template) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.Types> types;

    public java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.Types> getTypes() {
        return types;
    }

    public void setTypes(java.util.Map<java.lang.String, org.apache.camel.v1.kameletspec.Types> types) {
        this.types = types;
    }
}
