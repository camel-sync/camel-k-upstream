...
public class IntegrationSpec implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1.integrationspec.Configuration> configuration;

    public java.util.List<org.apache.camel.v1.integrationspec.Configuration> getConfiguration() {
        return configuration;
    }

    public void setConfiguration(java.util.List<org.apache.camel.v1.integrationspec.Configuration> configuration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationspec.Flows> flows;

    public java.util.List<org.apache.camel.v1.integrationspec.Flows> getFlows() {
        return flows;
    }

    public void setFlows(java.util.List<org.apache.camel.v1.integrationspec.Flows> flows) {
        this.flows = flows;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationspec.Sources> sources;

    public java.util.List<org.apache.camel.v1.integrationspec.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<org.apache.camel.v1.integrationspec.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.Template template;

    public org.apache.camel.v1.integrationspec.Template getTemplate() {
        return template;
    }

    public void setTemplate(org.apache.camel.v1.integrationspec.Template template) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.Traits traits;

    public org.apache.camel.v1.integrationspec.Traits getTraits() {
        return traits;
    }

    public void setTraits(org.apache.camel.v1.integrationspec.Traits traits) {
        this.traits = traits;
    }
}
