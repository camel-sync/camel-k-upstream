...
public class Items implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.FieldRef fieldRef;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.FieldRef getFieldRef() {
        return fieldRef;
    }

    public void setFieldRef(org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.FieldRef fieldRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.ResourceFieldRef resourceFieldRef;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.ResourceFieldRef getResourceFieldRef() {
        return resourceFieldRef;
    }

    public void setResourceFieldRef(org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.downwardapi.items.ResourceFieldRef resourceFieldRef) {
