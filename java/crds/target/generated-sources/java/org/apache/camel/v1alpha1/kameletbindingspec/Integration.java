...
public class Integration implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Configuration> configuration;

    public java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Configuration> getConfiguration() {
        return configuration;
    }

    public void setConfiguration(java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Configuration> configuration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Flows> flows;

    public java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Flows> getFlows() {
        return flows;
    }

    public void setFlows(java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Flows> flows) {
        this.flows = flows;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.IntegrationKit integrationKit;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.IntegrationKit getIntegrationKit() {
        return integrationKit;
    }

    public void setIntegrationKit(org.apache.camel.v1alpha1.kameletbindingspec.integration.IntegrationKit integrationKit) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Sources> sources;

    public java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.Sources> sources) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.Template template;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.Template getTemplate() {
        return template;
    }

    public void setTemplate(org.apache.camel.v1alpha1.kameletbindingspec.integration.Template template) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.Traits traits;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.Traits getTraits() {
        return traits;
    }

    public void setTraits(org.apache.camel.v1alpha1.kameletbindingspec.integration.Traits traits) {
        this.traits = traits;
    }
}
