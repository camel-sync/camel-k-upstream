...
public class DownwardAPI implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.downwardapi.Items> items;

    public java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.downwardapi.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.downwardapi.Items> items) {
        this.items = items;
    }
}
