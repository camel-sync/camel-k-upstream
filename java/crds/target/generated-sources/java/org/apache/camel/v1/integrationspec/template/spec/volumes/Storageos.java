...
public class Storageos implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.volumes.storageos.SecretRef secretRef;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.storageos.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(org.apache.camel.v1.integrationspec.template.spec.volumes.storageos.SecretRef secretRef) {
