...
public class Repositories implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Releases releases;

    public org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Releases getReleases() {
        return releases;
    }

    public void setReleases(org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Releases releases) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Snapshots snapshots;

    public org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Snapshots getSnapshots() {
        return snapshots;
    }

    public void setSnapshots(org.apache.camel.v1.buildspec.tasks.builder.maven.repositories.Snapshots snapshots) {
