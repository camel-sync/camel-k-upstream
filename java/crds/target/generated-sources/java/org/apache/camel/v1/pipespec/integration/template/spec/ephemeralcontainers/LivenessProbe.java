...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Exec exec;

    public org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Grpc grpc;

    public org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.HttpGet httpGet;

    public org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.TcpSocket tcpSocket;

    public org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.livenessprobe.TcpSocket tcpSocket) {
