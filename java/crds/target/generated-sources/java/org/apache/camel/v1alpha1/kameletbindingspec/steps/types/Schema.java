...
public class Schema implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.ExternalDocs externalDocs;

    public org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.ExternalDocs getExternalDocs() {
        return externalDocs;
    }

    public void setExternalDocs(org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.ExternalDocs externalDocs) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.Properties> properties;

    public java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.Properties> getProperties() {
        return properties;
    }

    public void setProperties(java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletbindingspec.steps.types.schema.Properties> properties) {
