...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items> items;

    public java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items> items) {
        this.items = items;
    }
