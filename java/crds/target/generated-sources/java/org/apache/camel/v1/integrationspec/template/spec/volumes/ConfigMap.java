...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items> items;

    public java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items> items) {
        this.items = items;
    }
