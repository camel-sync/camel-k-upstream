...
public class Steps implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.steps.DataTypes> dataTypes;

    public java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.steps.DataTypes> getDataTypes() {
        return dataTypes;
    }

    public void setDataTypes(java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.steps.DataTypes> dataTypes) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.steps.Properties properties;

    public org.apache.camel.v1.pipespec.steps.Properties getProperties() {
        return properties;
    }

    public void setProperties(org.apache.camel.v1.pipespec.steps.Properties properties) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.steps.Ref ref;

    public org.apache.camel.v1.pipespec.steps.Ref getRef() {
        return ref;
    }

    public void setRef(org.apache.camel.v1.pipespec.steps.Ref ref) {
        this.ref = ref;
    }
