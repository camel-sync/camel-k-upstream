...
public class StartupProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Exec exec;

    public org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Exec getExec() {
        return exec;
    }

    public void setExec(org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Grpc grpc;

    public org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.HttpGet httpGet;

    public org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.TcpSocket tcpSocket;

    public org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(org.apache.camel.v1.pipespec.integration.template.spec.initcontainers.startupprobe.TcpSocket tcpSocket) {
