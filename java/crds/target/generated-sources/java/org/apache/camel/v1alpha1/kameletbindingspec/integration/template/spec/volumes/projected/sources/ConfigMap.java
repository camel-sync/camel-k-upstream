...
public class ConfigMap implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.projected.sources.configmap.Items> items;

    public java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.projected.sources.configmap.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.projected.sources.configmap.Items> items) {
        this.items = items;
    }
