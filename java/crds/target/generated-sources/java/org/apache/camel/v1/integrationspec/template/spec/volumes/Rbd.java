...
public class Rbd implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.volumes.rbd.SecretRef secretRef;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.rbd.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(org.apache.camel.v1.integrationspec.template.spec.volumes.rbd.SecretRef secretRef) {
