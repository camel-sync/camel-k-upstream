...
public class ReadinessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Exec exec;

    public org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Grpc grpc;

    public org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet httpGet;

    public org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket tcpSocket;

    public org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.readinessprobe.TcpSocket tcpSocket) {
