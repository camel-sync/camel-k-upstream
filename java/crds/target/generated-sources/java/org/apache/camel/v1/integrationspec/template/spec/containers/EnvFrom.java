...
public class EnvFrom implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.ConfigMapRef configMapRef;

    public org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.ConfigMapRef getConfigMapRef() {
        return configMapRef;
    }

    public void setConfigMapRef(org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.ConfigMapRef configMapRef) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.SecretRef secretRef;

    public org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(org.apache.camel.v1.integrationspec.template.spec.containers.envfrom.SecretRef secretRef) {
