...
public class DataTypes implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Headers> headers;

    public java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Headers> getHeaders() {
        return headers;
    }

    public void setHeaders(java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Headers> headers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Types> types;

    public java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Types> getTypes() {
        return types;
    }

    public void setTypes(java.util.Map<java.lang.String, org.apache.camel.v1alpha1.kameletspec.datatypes.Types> types) {
        this.types = types;
    }
}
