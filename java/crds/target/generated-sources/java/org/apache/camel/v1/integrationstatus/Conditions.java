...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"firstTruthyTime","lastTransitionTime","lastUpdateTime","message","pods","reason","status","type"})
...
public class Conditions implements io.fabric8.kubernetes.api.model.KubernetesResource {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("firstTruthyTime")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("First time the condition status transitioned to True.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.time.ZonedDateTime firstTruthyTime;

    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ssVV")
    public java.time.ZonedDateTime getFirstTruthyTime() {
        return firstTruthyTime;
    }

    @com.fasterxml.jackson.annotation.JsonFormat(pattern = "yyyy-MM-dd'T'HH:mm:ss[XXX][VV]")
    public void setFirstTruthyTime(java.time.ZonedDateTime firstTruthyTime) {
     ...
     */
    @com.fasterxml.jackson.annotation.JsonProperty("pods")
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Pods collect health and conditions information from the owned PODs")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationstatus.conditions.Pods> pods;

    public java.util.List<org.apache.camel.v1.integrationstatus.conditions.Pods> getPods() {
        return pods;
    }

    public void setPods(java.util.List<org.apache.camel.v1.integrationstatus.conditions.Pods> pods) {
        this.pods = pods;
    }
    ...
    @io.fabric8.generator.annotation.Required()
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("Type of integration condition.")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private String type;
