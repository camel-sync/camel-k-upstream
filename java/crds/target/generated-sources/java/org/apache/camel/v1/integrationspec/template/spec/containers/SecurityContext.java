...
public class SecurityContext implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.Capabilities capabilities;

    public org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.Capabilities getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.Capabilities capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeLinuxOptions seLinuxOptions;

    public org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeLinuxOptions getSeLinuxOptions() {
        return seLinuxOptions;
    }

    public void setSeLinuxOptions(org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeLinuxOptions seLinuxOptions) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeccompProfile seccompProfile;

    public org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeccompProfile getSeccompProfile() {
        return seccompProfile;
    }

    public void setSeccompProfile(org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.SeccompProfile seccompProfile) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.WindowsOptions windowsOptions;

    public org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.WindowsOptions getWindowsOptions() {
        return windowsOptions;
    }

    public void setWindowsOptions(org.apache.camel.v1.integrationspec.template.spec.containers.securitycontext.WindowsOptions windowsOptions) {
