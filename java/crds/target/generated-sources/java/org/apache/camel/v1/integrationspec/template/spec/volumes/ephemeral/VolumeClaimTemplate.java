...
public class VolumeClaimTemplate implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Metadata metadata;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Metadata getMetadata() {
        return metadata;
    }

    public void setMetadata(org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Metadata metadata) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Spec spec;

    public org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Spec getSpec() {
        return spec;
    }

    public void setSpec(org.apache.camel.v1.integrationspec.template.spec.volumes.ephemeral.volumeclaimtemplate.Spec spec) {
        this.spec = spec;
    }
}
