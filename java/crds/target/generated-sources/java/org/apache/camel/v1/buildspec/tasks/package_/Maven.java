...
public class Maven implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets> caSecrets;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets> getCaSecrets() {
        return caSecrets;
    }

    public void setCaSecrets(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets> caSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Extension> extension;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Extension> getExtension() {
        return extension;
    }

    public void setExtension(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Extension> extension) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles> profiles;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles> getProfiles() {
        return profiles;
    }

    public void setProfiles(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles> profiles) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories> repositories;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories> getRepositories() {
        return repositories;
    }

    public void setRepositories(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories> repositories) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Servers> servers;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Servers> getServers() {
        return servers;
    }

    public void setServers(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.maven.Servers> servers) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.package_.maven.Settings settings;

    public org.apache.camel.v1.buildspec.tasks.package_.maven.Settings getSettings() {
        return settings;
    }

    public void setSettings(org.apache.camel.v1.buildspec.tasks.package_.maven.Settings settings) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurity settingsSecurity;

    public org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurity getSettingsSecurity() {
        return settingsSecurity;
    }

    public void setSettingsSecurity(org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurity settingsSecurity) {
