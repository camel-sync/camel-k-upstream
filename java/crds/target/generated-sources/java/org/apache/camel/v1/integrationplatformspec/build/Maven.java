...
public class Maven implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets> caSecrets;

    public java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets> getCaSecrets() {
        return caSecrets;
    }

    public void setCaSecrets(java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets> caSecrets) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Extension> extension;

    public java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Extension> getExtension() {
        return extension;
    }

    public void setExtension(java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Extension> extension) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Profiles> profiles;

    public java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Profiles> getProfiles() {
        return profiles;
    }

    public void setProfiles(java.util.List<org.apache.camel.v1.integrationplatformspec.build.maven.Profiles> profiles) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationplatformspec.build.maven.Settings settings;

    public org.apache.camel.v1.integrationplatformspec.build.maven.Settings getSettings() {
        return settings;
    }

    public void setSettings(org.apache.camel.v1.integrationplatformspec.build.maven.Settings settings) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.integrationplatformspec.build.maven.SettingsSecurity settingsSecurity;

    public org.apache.camel.v1.integrationplatformspec.build.maven.SettingsSecurity getSettingsSecurity() {
        return settingsSecurity;
    }

    public void setSettingsSecurity(org.apache.camel.v1.integrationplatformspec.build.maven.SettingsSecurity settingsSecurity) {
