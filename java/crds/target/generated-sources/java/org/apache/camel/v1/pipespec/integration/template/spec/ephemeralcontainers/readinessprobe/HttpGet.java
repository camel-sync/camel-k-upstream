...
public class HttpGet implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.readinessprobe.httpget.HttpHeaders> httpHeaders;

    public java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.readinessprobe.httpget.HttpHeaders> getHttpHeaders() {
        return httpHeaders;
    }

    public void setHttpHeaders(java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.ephemeralcontainers.readinessprobe.httpget.HttpHeaders> httpHeaders) {
