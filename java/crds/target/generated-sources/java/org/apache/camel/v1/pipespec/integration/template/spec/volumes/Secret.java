...
public class Secret implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.volumes.secret.Items> items;

    public java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.volumes.secret.Items> getItems() {
        return items;
    }

    public void setItems(java.util.List<org.apache.camel.v1.pipespec.integration.template.spec.volumes.secret.Items> items) {
        this.items = items;
    }
