...
public class Dependencies implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions> exclusions;

    public java.util.List<org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions> getExclusions() {
        return exclusions;
    }

    public void setExclusions(java.util.List<org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions> exclusions) {
