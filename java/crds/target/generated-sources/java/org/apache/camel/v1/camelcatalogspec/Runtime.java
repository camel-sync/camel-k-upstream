...
public class Runtime implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.Map<java.lang.String, org.apache.camel.v1.camelcatalogspec.runtime.Capabilities> capabilities;

    public java.util.Map<java.lang.String, org.apache.camel.v1.camelcatalogspec.runtime.Capabilities> getCapabilities() {
        return capabilities;
    }

    public void setCapabilities(java.util.Map<java.lang.String, org.apache.camel.v1.camelcatalogspec.runtime.Capabilities> capabilities) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.camelcatalogspec.runtime.Dependencies> dependencies;

    public java.util.List<org.apache.camel.v1.camelcatalogspec.runtime.Dependencies> getDependencies() {
        return dependencies;
    }

    public void setDependencies(java.util.List<org.apache.camel.v1.camelcatalogspec.runtime.Dependencies> dependencies) {
