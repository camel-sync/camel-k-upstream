...
public class Package implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.package_.Configuration configuration;

    public org.apache.camel.v1.buildspec.tasks.package_.Configuration getConfiguration() {
        return configuration;
    }

    public void setConfiguration(org.apache.camel.v1.buildspec.tasks.package_.Configuration configuration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.package_.Maven maven;

    public org.apache.camel.v1.buildspec.tasks.package_.Maven getMaven() {
        return maven;
    }

    public void setMaven(org.apache.camel.v1.buildspec.tasks.package_.Maven maven) {
        this.maven = maven;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.package_.Runtime runtime;

    public org.apache.camel.v1.buildspec.tasks.package_.Runtime getRuntime() {
        return runtime;
    }

    public void setRuntime(org.apache.camel.v1.buildspec.tasks.package_.Runtime runtime) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<org.apache.camel.v1.buildspec.tasks.package_.Sources> sources;

    public java.util.List<org.apache.camel.v1.buildspec.tasks.package_.Sources> getSources() {
        return sources;
    }

    public void setSources(java.util.List<org.apache.camel.v1.buildspec.tasks.package_.Sources> sources) {
