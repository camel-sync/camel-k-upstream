...
public class LivenessProbe implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Exec exec;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Exec getExec() {
        return exec;
    }

    public void setExec(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Exec exec) {
        this.exec = exec;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Grpc grpc;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Grpc getGrpc() {
        return grpc;
    }

    public void setGrpc(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.Grpc grpc) {
        this.grpc = grpc;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.HttpGet httpGet;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.HttpGet getHttpGet() {
        return httpGet;
    }

    public void setHttpGet(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.HttpGet httpGet) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.TcpSocket tcpSocket;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.TcpSocket getTcpSocket() {
        return tcpSocket;
    }

    public void setTcpSocket(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.livenessprobe.TcpSocket tcpSocket) {
