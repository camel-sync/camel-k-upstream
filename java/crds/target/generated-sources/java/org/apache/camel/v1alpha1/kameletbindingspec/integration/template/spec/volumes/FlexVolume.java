...
public class FlexVolume implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.flexvolume.SecretRef secretRef;

    public org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.flexvolume.SecretRef getSecretRef() {
        return secretRef;
    }

    public void setSecretRef(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.volumes.flexvolume.SecretRef secretRef) {
