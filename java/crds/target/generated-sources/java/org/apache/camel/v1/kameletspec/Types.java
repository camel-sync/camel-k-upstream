...
public class Types implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.kameletspec.types.Schema schema;

    public org.apache.camel.v1.kameletspec.types.Schema getSchema() {
        return schema;
    }

    public void setSchema(org.apache.camel.v1.kameletspec.types.Schema schema) {
        this.schema = schema;
    }
}
