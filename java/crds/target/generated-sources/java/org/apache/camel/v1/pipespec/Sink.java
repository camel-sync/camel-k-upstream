...
public class Sink implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.sink.DataTypes> dataTypes;

    public java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.sink.DataTypes> getDataTypes() {
        return dataTypes;
    }

    public void setDataTypes(java.util.Map<java.lang.String, org.apache.camel.v1.pipespec.sink.DataTypes> dataTypes) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.sink.Properties properties;

    public org.apache.camel.v1.pipespec.sink.Properties getProperties() {
        return properties;
    }

    public void setProperties(org.apache.camel.v1.pipespec.sink.Properties properties) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.pipespec.sink.Ref ref;

    public org.apache.camel.v1.pipespec.sink.Ref getRef() {
        return ref;
    }

    public void setRef(org.apache.camel.v1.pipespec.sink.Ref ref) {
        this.ref = ref;
    }
