...
@com.fasterxml.jackson.annotation.JsonPropertyOrder({"baseImage","cache","configuration","contextDir","executorImage","image","name","registry","verbose"})
...
public class Kaniko implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonPropertyDescription("use a cache")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.kaniko.Cache cache;

    public org.apache.camel.v1.buildspec.tasks.kaniko.Cache getCache() {
        return cache;
    }

    public void setCache(org.apache.camel.v1.buildspec.tasks.kaniko.Cache cache) {
        this.cache = cache;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.kaniko.Configuration configuration;

    public org.apache.camel.v1.buildspec.tasks.kaniko.Configuration getConfiguration() {
        return configuration;
    }

    public void setConfiguration(org.apache.camel.v1.buildspec.tasks.kaniko.Configuration configuration) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private org.apache.camel.v1.buildspec.tasks.kaniko.Registry registry;

    public org.apache.camel.v1.buildspec.tasks.kaniko.Registry getRegistry() {
        return registry;
    }

    public void setRegistry(org.apache.camel.v1.buildspec.tasks.kaniko.Registry registry) {
