...
import org.apache.camel.v1.buildspec.tasks.spectrum.ConfigurationBuilder;
import org.apache.camel.v1.buildspec.tasks.spectrum.Configuration;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.String;
import org.apache.camel.v1.buildspec.tasks.spectrum.ConfigurationFluent;
import org.apache.camel.v1.buildspec.tasks.spectrum.Registry;
import org.apache.camel.v1.buildspec.tasks.spectrum.RegistryFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import org.apache.camel.v1.buildspec.tasks.spectrum.RegistryBuilder;

/**
 * Generated
 */
@SuppressWarnings("unchecked")
public class SpectrumFluent<A extends SpectrumFluent<A>> extends BaseFluent<A>{
  public SpectrumFluent() {
  }
  
  public SpectrumFluent(Spectrum instance) {
  ...
  protected void copyInstance(Spectrum instance) {
    instance = (instance != null ? instance : new Spectrum());
    if (instance != null) {
  ...
  public RegistryNested<A> editSpectrumRegistry() {
  ...
  public boolean equals(Object o) {
    ...
    SpectrumFluent that = (SpectrumFluent) o;
  ...
  public class ConfigurationNested<N> extends ConfigurationFluent<ConfigurationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SpectrumFluent.this.withConfiguration(builder.build());
    }
  ...
  public class RegistryNested<N> extends RegistryFluent<RegistryNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SpectrumFluent.this.withRegistry(builder.build());
    }
    
    public N endSpectrumRegistry() {
      return and();
    }
