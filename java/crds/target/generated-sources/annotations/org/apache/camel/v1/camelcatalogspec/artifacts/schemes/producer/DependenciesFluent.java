...
public class DependenciesFluent<A extends DependenciesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToExclusions(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions... items) {
    if (this.exclusions == null) {this.exclusions = new ArrayList<ExclusionsBuilder>();}
  ...
  public A removeFromExclusions(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions... items) {
  ...
  public A withExclusions(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.dependencies.Exclusions... exclusions) {
    if (this.exclusions != null) {
