...
import org.apache.camel.v1.buildspec.tasks.package_.maven.ExtensionBuilder;
import java.lang.String;
import org.apache.camel.v1.buildspec.tasks.package_.maven.Servers;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import org.apache.camel.v1.buildspec.tasks.package_.maven.ExtensionFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import org.apache.camel.v1.buildspec.tasks.package_.maven.RepositoriesFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.Settings;
import org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurityBuilder;
import org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurity;
import java.util.Collection;
import java.lang.Object;
import java.util.Map;
import org.apache.camel.v1.buildspec.tasks.package_.maven.ServersBuilder;
import org.apache.camel.v1.buildspec.tasks.package_.maven.ServersFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import org.apache.camel.v1.buildspec.tasks.package_.maven.RepositoriesBuilder;
import org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsBuilder;
import java.util.Iterator;
import org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecretsFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecretsBuilder;
import org.apache.camel.v1.buildspec.tasks.package_.maven.ProfilesBuilder;
import org.apache.camel.v1.buildspec.tasks.package_.maven.ProfilesFluent;
import org.apache.camel.v1.buildspec.tasks.package_.maven.Extension;
import org.apache.camel.v1.buildspec.tasks.package_.maven.SettingsSecurityFluent;
...
public class MavenFluent<A extends MavenFluent<A>> extends BaseFluent<A>{
  ...
  public A addToCaSecrets(org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets... items) {
    if (this.caSecrets == null) {this.caSecrets = new ArrayList<CaSecretsBuilder>();}
  ...
  public A addAllToPackage_CaSecrets(Collection<CaSecrets> items) {
    if (this.caSecrets == null) {this.caSecrets = new ArrayList<CaSecretsBuilder>();}
    for (CaSecrets item : items) {CaSecretsBuilder builder = new CaSecretsBuilder(item);_visitables.get("caSecrets").add(builder);this.caSecrets.add(builder);} return (A)this;
  }
  
  public A removeFromCaSecrets(org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets... items) {
  ...
  public A removeAllFromPackage_CaSecrets(Collection<CaSecrets> items) {
    if (this.caSecrets == null) return (A)this;
    for (CaSecrets item : items) {CaSecretsBuilder builder = new CaSecretsBuilder(item);_visitables.get("caSecrets").remove(builder); this.caSecrets.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPackage_CaSecrets(Predicate<CaSecretsBuilder> predicate) {
  ...
  public A withCaSecrets(org.apache.camel.v1.buildspec.tasks.package_.maven.CaSecrets... caSecrets) {
    if (this.caSecrets != null) {
  ...
  public A addToExtension(org.apache.camel.v1.buildspec.tasks.package_.maven.Extension... items) {
    if (this.extension == null) {this.extension = new ArrayList<ExtensionBuilder>();}
  ...
  public A addAllToPackage_Extension(Collection<Extension> items) {
    if (this.extension == null) {this.extension = new ArrayList<ExtensionBuilder>();}
    for (Extension item : items) {ExtensionBuilder builder = new ExtensionBuilder(item);_visitables.get("extension").add(builder);this.extension.add(builder);} return (A)this;
  }
  
  public A removeFromExtension(org.apache.camel.v1.buildspec.tasks.package_.maven.Extension... items) {
  ...
  public A removeAllFromPackage_Extension(Collection<Extension> items) {
    if (this.extension == null) return (A)this;
    for (Extension item : items) {ExtensionBuilder builder = new ExtensionBuilder(item);_visitables.get("extension").remove(builder); this.extension.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPackage_Extension(Predicate<ExtensionBuilder> predicate) {
  ...
  public A withExtension(org.apache.camel.v1.buildspec.tasks.package_.maven.Extension... extension) {
    if (this.extension != null) {
  ...
  public A addToProfiles(org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles... items) {
    if (this.profiles == null) {this.profiles = new ArrayList<ProfilesBuilder>();}
  ...
  public A addAllToPackage_Profiles(Collection<Profiles> items) {
    if (this.profiles == null) {this.profiles = new ArrayList<ProfilesBuilder>();}
    for (Profiles item : items) {ProfilesBuilder builder = new ProfilesBuilder(item);_visitables.get("profiles").add(builder);this.profiles.add(builder);} return (A)this;
  }
  
  public A removeFromProfiles(org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles... items) {
  ...
  public A removeAllFromPackage_Profiles(Collection<Profiles> items) {
    if (this.profiles == null) return (A)this;
    for (Profiles item : items) {ProfilesBuilder builder = new ProfilesBuilder(item);_visitables.get("profiles").remove(builder); this.profiles.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPackage_Profiles(Predicate<ProfilesBuilder> predicate) {
  ...
  public A withProfiles(org.apache.camel.v1.buildspec.tasks.package_.maven.Profiles... profiles) {
    if (this.profiles != null) {
        this.profiles.clear();
  ...
  public A addToRepositories(org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories... items) {
    if (this.repositories == null) {this.repositories = new ArrayList<RepositoriesBuilder>();}
  ...
  public A addAllToPackage_Repositories(Collection<Repositories> items) {
    if (this.repositories == null) {this.repositories = new ArrayList<RepositoriesBuilder>();}
    for (Repositories item : items) {RepositoriesBuilder builder = new RepositoriesBuilder(item);_visitables.get("repositories").add(builder);this.repositories.add(builder);} return (A)this;
  }
  
  public A removeFromRepositories(org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories... items) {
  ...
  public A removeAllFromPackage_Repositories(Collection<Repositories> items) {
    if (this.repositories == null) return (A)this;
    for (Repositories item : items) {RepositoriesBuilder builder = new RepositoriesBuilder(item);_visitables.get("repositories").remove(builder); this.repositories.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPackage_Repositories(Predicate<RepositoriesBuilder> predicate) {
  ...
  public A withRepositories(org.apache.camel.v1.buildspec.tasks.package_.maven.Repositories... repositories) {
    if (this.repositories != null) {
  ...
  public A addToServers(org.apache.camel.v1.buildspec.tasks.package_.maven.Servers... items) {
    if (this.servers == null) {this.servers = new ArrayList<ServersBuilder>();}
  ...
  public A addAllToPackage_Servers(Collection<Servers> items) {
    if (this.servers == null) {this.servers = new ArrayList<ServersBuilder>();}
    for (Servers item : items) {ServersBuilder builder = new ServersBuilder(item);_visitables.get("servers").add(builder);this.servers.add(builder);} return (A)this;
  }
  
  public A removeFromServers(org.apache.camel.v1.buildspec.tasks.package_.maven.Servers... items) {
  ...
  public A removeAllFromPackage_Servers(Collection<Servers> items) {
    if (this.servers == null) return (A)this;
    for (Servers item : items) {ServersBuilder builder = new ServersBuilder(item);_visitables.get("servers").remove(builder); this.servers.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPackage_Servers(Predicate<ServersBuilder> predicate) {
  ...
  public A withServers(org.apache.camel.v1.buildspec.tasks.package_.maven.Servers... servers) {
    if (this.servers != null) {
        this.servers.clear();
  ...
  public SettingsNested<A> editPackage_Settings() {
  ...
  public SettingsSecurityNested<A> editPackage_SettingsSecurity() {
  ...
  public class RepositoriesNested<N> extends RepositoriesFluent<RepositoriesNested<N>> implements Nested<N>{
    ...
    public N endPackage_Repository() {
      return and();
    }
  ...
  public class SettingsSecurityNested<N> extends SettingsSecurityFluent<SettingsSecurityNested<N>> implements Nested<N>{
    ...
    public N endPackage_SettingsSecurity() {
      return and();
    }
