...
import org.apache.camel.v1alpha1.kameletbindingspec.source.types.schema.ExternalDocsFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.source.types.schema.ExternalDocsBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.source.types.schema.Properties;
import org.apache.camel.v1alpha1.kameletbindingspec.source.types.schema.ExternalDocs;
...
public class SchemaFluent<A extends SchemaFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Schema instance) {
    instance = (instance != null ? instance : new Schema());
    if (instance != null) {
  ...
  public ExternalDocsNested<A> editSourceExternalDocs() {
  ...
  public boolean equals(Object o) {
    ...
    SchemaFluent that = (SchemaFluent) o;
  ...
  public class ExternalDocsNested<N> extends ExternalDocsFluent<ExternalDocsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SchemaFluent.this.withExternalDocs(builder.build());
    }
    
    public N endSourceExternalDocs() {
      return and();
    }
