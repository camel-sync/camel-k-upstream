...
import org.apache.camel.v1alpha1.kameletbindingstatus.ConditionsBuilder;
...
public class KameletBindingStatusFluent<A extends KameletBindingStatusFluent<A>> extends BaseFluent<A>{
  public KameletBindingStatusFluent() {
  }
  
  public KameletBindingStatusFluent(KameletBindingStatus instance) {
  ...
  protected void copyInstance(KameletBindingStatus instance) {
    instance = (instance != null ? instance : new KameletBindingStatus());
    if (instance != null) {
  ...
  public A addToConditions(org.apache.camel.v1alpha1.kameletbindingstatus.Conditions... items) {
    if (this.conditions == null) {this.conditions = new ArrayList<ConditionsBuilder>();}
  ...
  public A addAllToKameletbindingstatusConditions(Collection<Conditions> items) {
    if (this.conditions == null) {this.conditions = new ArrayList<ConditionsBuilder>();}
    for (Conditions item : items) {ConditionsBuilder builder = new ConditionsBuilder(item);_visitables.get("conditions").add(builder);this.conditions.add(builder);} return (A)this;
  }
  
  public A removeFromConditions(org.apache.camel.v1alpha1.kameletbindingstatus.Conditions... items) {
  ...
  public A removeAllFromKameletbindingstatusConditions(Collection<Conditions> items) {
    if (this.conditions == null) return (A)this;
    for (Conditions item : items) {ConditionsBuilder builder = new ConditionsBuilder(item);_visitables.get("conditions").remove(builder); this.conditions.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromKameletbindingstatusConditions(Predicate<ConditionsBuilder> predicate) {
  ...
  public A withConditions(org.apache.camel.v1alpha1.kameletbindingstatus.Conditions... conditions) {
    if (this.conditions != null) {
  ...
  public boolean equals(Object o) {
    ...
    KameletBindingStatusFluent that = (KameletBindingStatusFluent) o;
  ...
  public class ConditionsNested<N> extends ConditionsFluent<ConditionsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingStatusFluent.this.setToConditions(index,builder.build());
    }
    
    public N endKameletbindingstatusCondition() {
      return and();
    }
