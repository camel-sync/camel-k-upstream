...
public class PodsFluent<A extends PodsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToHealth(org.apache.camel.v1.integrationstatus.conditions.pods.Health... items) {
    if (this.health == null) {this.health = new ArrayList<HealthBuilder>();}
  ...
  public A removeFromHealth(org.apache.camel.v1.integrationstatus.conditions.pods.Health... items) {
  ...
  public A withHealth(org.apache.camel.v1.integrationstatus.conditions.pods.Health... health) {
    if (this.health != null) {
        this.health.clear();
