...
import org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.ItemsBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.Collection;
import java.lang.Object;
import java.util.List;
import org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items;
import org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.ItemsFluent;
...
public class SecretFluent<A extends SecretFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items... items) {
    if (this.items == null) {this.items = new ArrayList<ItemsBuilder>();}
  ...
  public A removeFromItems(org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items... items) {
  ...
  public A withItems(org.apache.camel.v1.integrationspec.template.spec.volumes.projected.sources.secret.Items... items) {
    if (this.items != null) {
        this.items.clear();
