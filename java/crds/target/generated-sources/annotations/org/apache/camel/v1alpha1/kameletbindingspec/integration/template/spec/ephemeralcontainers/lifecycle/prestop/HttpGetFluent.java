...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders;
...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeadersFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeadersBuilder;
...
public class HttpGetFluent<A extends HttpGetFluent<A>> extends BaseFluent<A>{
  ...
  public A addToHttpHeaders(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders... items) {
    if (this.httpHeaders == null) {this.httpHeaders = new ArrayList<HttpHeadersBuilder>();}
  ...
  public A addAllToPrestopHttpHeaders(Collection<HttpHeaders> items) {
    if (this.httpHeaders == null) {this.httpHeaders = new ArrayList<HttpHeadersBuilder>();}
    for (HttpHeaders item : items) {HttpHeadersBuilder builder = new HttpHeadersBuilder(item);_visitables.get("httpHeaders").add(builder);this.httpHeaders.add(builder);} return (A)this;
  }
  
  public A removeFromHttpHeaders(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders... items) {
  ...
  public A removeAllFromPrestopHttpHeaders(Collection<HttpHeaders> items) {
    if (this.httpHeaders == null) return (A)this;
    for (HttpHeaders item : items) {HttpHeadersBuilder builder = new HttpHeadersBuilder(item);_visitables.get("httpHeaders").remove(builder); this.httpHeaders.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromPrestopHttpHeaders(Predicate<HttpHeadersBuilder> predicate) {
  ...
  public A withHttpHeaders(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.prestop.httpget.HttpHeaders... httpHeaders) {
    if (this.httpHeaders != null) {
