...
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PreStopBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PostStart;
import java.lang.String;
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PreStopFluent;
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PreStop;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PostStartFluent;
import java.lang.Object;
import org.apache.camel.v1.pipespec.integration.template.spec.containers.lifecycle.PostStartBuilder;
...
public class LifecycleFluent<A extends LifecycleFluent<A>> extends BaseFluent<A>{
  ...
  public PostStartNested<A> editIntegrationPostStart() {
  ...
  public PreStopNested<A> editIntegrationPreStop() {
  ...
  public class PostStartNested<N> extends PostStartFluent<PostStartNested<N>> implements Nested<N>{
    ...
    public N endIntegrationPostStart() {
      return and();
    }
  ...
  public class PreStopNested<N> extends PreStopFluent<PreStopNested<N>> implements Nested<N>{
    ...
    public N endIntegrationPreStop() {
      return and();
    }
