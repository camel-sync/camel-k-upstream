...
import org.apache.camel.v1.integrationspec.template.spec.volumes.downwardapi.ItemsBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.Collection;
import java.lang.Object;
import java.util.List;
import org.apache.camel.v1.integrationspec.template.spec.volumes.downwardapi.Items;
...
public class DownwardAPIFluent<A extends DownwardAPIFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(org.apache.camel.v1.integrationspec.template.spec.volumes.downwardapi.Items... items) {
    if (this.items == null) {this.items = new ArrayList<ItemsBuilder>();}
  ...
  public A removeFromItems(org.apache.camel.v1.integrationspec.template.spec.volumes.downwardapi.Items... items) {
  ...
  public A withItems(org.apache.camel.v1.integrationspec.template.spec.volumes.downwardapi.Items... items) {
    if (this.items != null) {
        this.items.clear();
