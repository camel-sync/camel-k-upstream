...
import org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicyFluent;
import java.util.ArrayList;
import java.lang.String;
import org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicy;
import java.util.function.Predicate;
import org.apache.camel.v1.integrationspec.template.spec.containers.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import org.apache.camel.v1.integrationspec.template.spec.containers.StartupProbeFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.ResourcesBuilder;
import java.lang.Boolean;
import org.apache.camel.v1.integrationspec.template.spec.containers.LivenessProbe;
import org.apache.camel.v1.integrationspec.template.spec.containers.EnvFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.Lifecycle;
import org.apache.camel.v1.integrationspec.template.spec.containers.VolumeMountsFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.ReadinessProbeFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.LifecycleBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.ReadinessProbeBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.VolumeDevicesBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.StartupProbeBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.EnvFromBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.LivenessProbeFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.SecurityContextFluent;
import java.util.Collection;
import java.lang.Object;
import org.apache.camel.v1.integrationspec.template.spec.containers.ResourcesFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.Resources;
import org.apache.camel.v1.integrationspec.template.spec.containers.VolumeDevicesFluent;
...
import org.apache.camel.v1.integrationspec.template.spec.containers.VolumeMountsBuilder;
...
import org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicyBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.Ports;
import org.apache.camel.v1.integrationspec.template.spec.containers.LivenessProbeBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.LifecycleFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.EnvBuilder;
import org.apache.camel.v1.integrationspec.template.spec.containers.EnvFrom;
import org.apache.camel.v1.integrationspec.template.spec.containers.PortsFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.EnvFromFluent;
import org.apache.camel.v1.integrationspec.template.spec.containers.SecurityContext;
...
public class ContainersFluent<A extends ContainersFluent<A>> extends BaseFluent<A>{
  ...
  public A addToEnv(org.apache.camel.v1.integrationspec.template.spec.containers.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A removeFromEnv(org.apache.camel.v1.integrationspec.template.spec.containers.Env... items) {
  ...
  public A withEnv(org.apache.camel.v1.integrationspec.template.spec.containers.Env... env) {
    if (this.env != null) {
        this.env.clear();
  ...
  public A addToEnvFrom(org.apache.camel.v1.integrationspec.template.spec.containers.EnvFrom... items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
  ...
  public A addAllToEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").add(builder);this.envFrom.add(builder);} return (A)this;
  }
  
  public A removeFromEnvFrom(org.apache.camel.v1.integrationspec.template.spec.containers.EnvFrom... items) {
  ...
  public A removeAllFromEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) return (A)this;
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").remove(builder); this.envFrom.remove(builder);} return (A)this;
  }
  ...
  public A withEnvFrom(org.apache.camel.v1.integrationspec.template.spec.containers.EnvFrom... envFrom) {
    if (this.envFrom != null) {
        this.envFrom.clear();
  ...
  public A addToPorts(org.apache.camel.v1.integrationspec.template.spec.containers.Ports... items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
  ...
  public A addAllToPorts(Collection<Ports> items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  
  public A removeFromPorts(org.apache.camel.v1.integrationspec.template.spec.containers.Ports... items) {
  ...
  public A removeAllFromPorts(Collection<Ports> items) {
    if (this.ports == null) return (A)this;
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").remove(builder); this.ports.remove(builder);} return (A)this;
  }
  ...
  public A withPorts(org.apache.camel.v1.integrationspec.template.spec.containers.Ports... ports) {
    if (this.ports != null) {
        this.ports.clear();
  ...
  public A addToResizePolicy(org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicy... items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
  ...
  public A addAllToResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").add(builder);this.resizePolicy.add(builder);} return (A)this;
  }
  
  public A removeFromResizePolicy(org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicy... items) {
  ...
  public A removeAllFromResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) return (A)this;
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").remove(builder); this.resizePolicy.remove(builder);} return (A)this;
  }
  ...
  public A withResizePolicy(org.apache.camel.v1.integrationspec.template.spec.containers.ResizePolicy... resizePolicy) {
    if (this.resizePolicy != null) {
  ...
  public A addToVolumeDevices(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeDevices... items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
  ...
  public A addAllToVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").add(builder);this.volumeDevices.add(builder);} return (A)this;
  }
  
  public A removeFromVolumeDevices(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeDevices... items) {
  ...
  public A removeAllFromVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) return (A)this;
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").remove(builder); this.volumeDevices.remove(builder);} return (A)this;
  }
  ...
  public A withVolumeDevices(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeDevices... volumeDevices) {
    if (this.volumeDevices != null) {
  ...
  public A addToVolumeMounts(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeMounts... items) {
    if (this.volumeMounts == null) {this.volumeMounts = new ArrayList<VolumeMountsBuilder>();}
  ...
  public A removeFromVolumeMounts(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeMounts... items) {
  ...
  public A withVolumeMounts(org.apache.camel.v1.integrationspec.template.spec.containers.VolumeMounts... volumeMounts) {
    if (this.volumeMounts != null) {
