...
import org.apache.camel.v1.integrationplatformspec.build.maven.ExtensionBuilder;
import java.lang.String;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import org.apache.camel.v1.integrationplatformspec.build.maven.SettingsBuilder;
import org.apache.camel.v1.integrationplatformspec.build.maven.ExtensionFluent;
import org.apache.camel.v1.integrationplatformspec.build.maven.Profiles;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.Iterator;
import java.util.List;
import org.apache.camel.v1.integrationplatformspec.build.maven.CaSecretsFluent;
...
import org.apache.camel.v1.integrationplatformspec.build.maven.CaSecretsBuilder;
import org.apache.camel.v1.integrationplatformspec.build.maven.ProfilesBuilder;
import org.apache.camel.v1.integrationplatformspec.build.maven.SettingsSecurityBuilder;
import org.apache.camel.v1.integrationplatformspec.build.maven.ProfilesFluent;
...
import org.apache.camel.v1.integrationplatformspec.build.maven.SettingsSecurityFluent;
...
public class MavenFluent<A extends MavenFluent<A>> extends BaseFluent<A>{
  ...
  public A addToCaSecrets(org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets... items) {
    if (this.caSecrets == null) {this.caSecrets = new ArrayList<CaSecretsBuilder>();}
  ...
  public A removeFromCaSecrets(org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets... items) {
  ...
  public A withCaSecrets(org.apache.camel.v1.integrationplatformspec.build.maven.CaSecrets... caSecrets) {
    if (this.caSecrets != null) {
  ...
  public A addToExtension(org.apache.camel.v1.integrationplatformspec.build.maven.Extension... items) {
    if (this.extension == null) {this.extension = new ArrayList<ExtensionBuilder>();}
  ...
  public A removeFromExtension(org.apache.camel.v1.integrationplatformspec.build.maven.Extension... items) {
  ...
  public A withExtension(org.apache.camel.v1.integrationplatformspec.build.maven.Extension... extension) {
    if (this.extension != null) {
  ...
  public A addToProfiles(org.apache.camel.v1.integrationplatformspec.build.maven.Profiles... items) {
    if (this.profiles == null) {this.profiles = new ArrayList<ProfilesBuilder>();}
  ...
  public A removeFromProfiles(org.apache.camel.v1.integrationplatformspec.build.maven.Profiles... items) {
  ...
  public A withProfiles(org.apache.camel.v1.integrationplatformspec.build.maven.Profiles... profiles) {
    if (this.profiles != null) {
        this.profiles.clear();
