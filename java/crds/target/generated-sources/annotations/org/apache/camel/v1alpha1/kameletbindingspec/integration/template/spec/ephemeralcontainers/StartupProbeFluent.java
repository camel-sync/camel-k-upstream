...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.HttpGetBuilder;
import java.lang.SuppressWarnings;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.HttpGet;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.ExecBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.TcpSocketBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.TcpSocketFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.Exec;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.HttpGetFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.Grpc;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.GrpcBuilder;
import java.lang.Integer;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.ExecFluent;
import java.lang.Long;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.GrpcFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.startupprobe.TcpSocket;
...
public class StartupProbeFluent<A extends StartupProbeFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(StartupProbe instance) {
  ...
  public ExecNested<A> editStartupprobeExec() {
  ...
  public GrpcNested<A> editStartupprobeGrpc() {
  ...
  public HttpGetNested<A> editStartupprobeHttpGet() {
  ...
  public TcpSocketNested<A> editStartupprobeTcpSocket() {
  ...
  public boolean equals(Object o) {
    ...
    StartupProbeFluent that = (StartupProbeFluent) o;
  ...
  public class ExecNested<N> extends ExecFluent<ExecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StartupProbeFluent.this.withExec(builder.build());
    }
  ...
  public class GrpcNested<N> extends GrpcFluent<GrpcNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StartupProbeFluent.this.withGrpc(builder.build());
    }
  ...
  public class HttpGetNested<N> extends HttpGetFluent<HttpGetNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StartupProbeFluent.this.withHttpGet(builder.build());
    }
  ...
  public class TcpSocketNested<N> extends TcpSocketFluent<TcpSocketNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) StartupProbeFluent.this.withTcpSocket(builder.build());
    }
