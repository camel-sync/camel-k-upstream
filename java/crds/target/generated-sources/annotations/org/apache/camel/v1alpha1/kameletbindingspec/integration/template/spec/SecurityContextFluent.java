...
public class SecurityContextFluent<A extends SecurityContextFluent<A>> extends BaseFluent<A>{
  ...
  public A addToSysctls(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.securitycontext.Sysctls... items) {
    if (this.sysctls == null) {this.sysctls = new ArrayList<SysctlsBuilder>();}
  ...
  public A removeFromSysctls(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.securitycontext.Sysctls... items) {
  ...
  public A withSysctls(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.securitycontext.Sysctls... sysctls) {
    if (this.sysctls != null) {
        this.sysctls.clear();
