...
public class ConditionsFluent<A extends ConditionsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPods(org.apache.camel.v1alpha1.kameletbindingstatus.conditions.Pods... items) {
    if (this.pods == null) {this.pods = new ArrayList<PodsBuilder>();}
  ...
  public A addAllToKameletbindingstatusPods(Collection<Pods> items) {
    if (this.pods == null) {this.pods = new ArrayList<PodsBuilder>();}
    for (Pods item : items) {PodsBuilder builder = new PodsBuilder(item);_visitables.get("pods").add(builder);this.pods.add(builder);} return (A)this;
  }
  
  public A removeFromPods(org.apache.camel.v1alpha1.kameletbindingstatus.conditions.Pods... items) {
  ...
  public A removeAllFromKameletbindingstatusPods(Collection<Pods> items) {
    if (this.pods == null) return (A)this;
    for (Pods item : items) {PodsBuilder builder = new PodsBuilder(item);_visitables.get("pods").remove(builder); this.pods.remove(builder);} return (A)this;
  }
  ...
  public A withPods(org.apache.camel.v1alpha1.kameletbindingstatus.conditions.Pods... pods) {
    if (this.pods != null) {
        this.pods.clear();
  ...
  public int hashCode() {
    return java.util.Objects.hash(lastTransitionTime,  lastUpdateTime,  message,  pods,  reason,  status,  type,  super.hashCode());
  }
