...
public class KameletSpecFluent<A extends KameletSpecFluent<A>> extends BaseFluent<A>{
  ...
  public A addToSources(org.apache.camel.v1.kameletspec.Sources... items) {
    if (this.sources == null) {this.sources = new ArrayList<SourcesBuilder>();}
  ...
  public A removeFromSources(org.apache.camel.v1.kameletspec.Sources... items) {
  ...
  public A withSources(org.apache.camel.v1.kameletspec.Sources... sources) {
    if (this.sources != null) {
        this.sources.clear();
