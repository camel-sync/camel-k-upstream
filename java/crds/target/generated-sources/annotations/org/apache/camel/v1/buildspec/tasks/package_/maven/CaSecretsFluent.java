...
public class CaSecretsFluent<A extends CaSecretsFluent<A>> extends BaseFluent<A>{
  ...
  public CaSecretsFluent(CaSecrets instance) {
  ...
  protected void copyInstance(CaSecrets instance) {
    instance = (instance != null ? instance : new CaSecrets());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    CaSecretsFluent that = (CaSecretsFluent) o;
