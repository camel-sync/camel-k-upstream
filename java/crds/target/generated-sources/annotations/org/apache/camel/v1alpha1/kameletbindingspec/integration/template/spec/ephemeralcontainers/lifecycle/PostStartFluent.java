...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.HttpGetBuilder;
import java.lang.SuppressWarnings;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.HttpGet;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.ExecBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.TcpSocketBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.TcpSocketFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.Exec;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.HttpGetFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.ExecFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.lifecycle.poststart.TcpSocket;

/**
 * Generated
 */
@SuppressWarnings("unchecked")
public class PostStartFluent<A extends PostStartFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(PostStart instance) {
  ...
  public ExecNested<A> editEphemeralcontainersExec() {
  ...
  public HttpGetNested<A> editEphemeralcontainersHttpGet() {
  ...
  public TcpSocketNested<A> editEphemeralcontainersTcpSocket() {
  ...
  public boolean equals(Object o) {
    ...
    PostStartFluent that = (PostStartFluent) o;
  ...
  public class ExecNested<N> extends ExecFluent<ExecNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PostStartFluent.this.withExec(builder.build());
    }
    
    public N endEphemeralcontainersExec() {
      return and();
    }
  ...
  public class HttpGetNested<N> extends HttpGetFluent<HttpGetNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PostStartFluent.this.withHttpGet(builder.build());
    }
    
    public N endEphemeralcontainersHttpGet() {
      return and();
    }
  ...
  public class TcpSocketNested<N> extends TcpSocketFluent<TcpSocketNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) PostStartFluent.this.withTcpSocket(builder.build());
    }
    
    public N endEphemeralcontainersTcpSocket() {
      return and();
    }
