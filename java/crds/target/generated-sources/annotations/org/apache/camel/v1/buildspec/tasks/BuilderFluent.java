...
public class BuilderFluent<A extends BuilderFluent<A>> extends BaseFluent<A>{
  ...
  public A addToSources(org.apache.camel.v1.buildspec.tasks.builder.Sources... items) {
    if (this.sources == null) {this.sources = new ArrayList<SourcesBuilder>();}
  ...
  public A removeFromSources(org.apache.camel.v1.buildspec.tasks.builder.Sources... items) {
  ...
  public A withSources(org.apache.camel.v1.buildspec.tasks.builder.Sources... sources) {
    if (this.sources != null) {
        this.sources.clear();
  ...
  public class MavenNested<N> extends MavenFluent<MavenNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuilderFluent.this.withMaven(builder.build());
    }
  ...
  public class RuntimeNested<N> extends RuntimeFluent<RuntimeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuilderFluent.this.withRuntime(builder.build());
    }
  ...
  public class SourcesNested<N> extends SourcesFluent<SourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) BuilderFluent.this.setToSources(index,builder.build());
    }
