...
public class ReleasesFluent<A extends ReleasesFluent<A>> extends BaseFluent<A>{
  ...
  public ReleasesFluent(Releases instance) {
  ...
  protected void copyInstance(Releases instance) {
    instance = (instance != null ? instance : new Releases());
    if (instance != null) {
  ...
  public boolean equals(Object o) {
    ...
    ReleasesFluent that = (ReleasesFluent) o;
