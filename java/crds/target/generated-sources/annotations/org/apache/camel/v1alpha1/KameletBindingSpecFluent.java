...
public class KameletBindingSpecFluent<A extends KameletBindingSpecFluent<A>> extends BaseFluent<A>{
  ...
  public KameletBindingSpecFluent(KameletBindingSpec instance) {
  ...
  protected void copyInstance(KameletBindingSpec instance) {
    instance = (instance != null ? instance : new KameletBindingSpec());
    if (instance != null) {
  ...
  public ErrorHandlerNested<A> editKameletbindingspecErrorHandler() {
  ...
  public IntegrationNested<A> editKameletbindingspecIntegration() {
  ...
  public SinkNested<A> editKameletbindingspecSink() {
  ...
  public SourceNested<A> editKameletbindingspecSource() {
  ...
  public A addToSteps(org.apache.camel.v1alpha1.kameletbindingspec.Steps... items) {
    if (this.steps == null) {this.steps = new ArrayList<StepsBuilder>();}
  ...
  public A addAllToKameletbindingspecSteps(Collection<Steps> items) {
    if (this.steps == null) {this.steps = new ArrayList<StepsBuilder>();}
    for (Steps item : items) {StepsBuilder builder = new StepsBuilder(item);_visitables.get("steps").add(builder);this.steps.add(builder);} return (A)this;
  }
  
  public A removeFromSteps(org.apache.camel.v1alpha1.kameletbindingspec.Steps... items) {
  ...
  public A removeAllFromKameletbindingspecSteps(Collection<Steps> items) {
    if (this.steps == null) return (A)this;
    for (Steps item : items) {StepsBuilder builder = new StepsBuilder(item);_visitables.get("steps").remove(builder); this.steps.remove(builder);} return (A)this;
  }
  ...
  public A withSteps(org.apache.camel.v1alpha1.kameletbindingspec.Steps... steps) {
    if (this.steps != null) {
        this.steps.clear();
  ...
  public boolean equals(Object o) {
    ...
    KameletBindingSpecFluent that = (KameletBindingSpecFluent) o;
  ...
  public class ErrorHandlerNested<N> extends ErrorHandlerFluent<ErrorHandlerNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingSpecFluent.this.withErrorHandler(builder.build());
    }
  ...
  public class IntegrationNested<N> extends IntegrationFluent<IntegrationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingSpecFluent.this.withIntegration(builder.build());
    }
  ...
  public class SinkNested<N> extends SinkFluent<SinkNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingSpecFluent.this.withSink(builder.build());
    }
  ...
  public class SourceNested<N> extends SourceFluent<SourceNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingSpecFluent.this.withSource(builder.build());
    }
  ...
  public class StepsNested<N> extends StepsFluent<StepsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KameletBindingSpecFluent.this.setToSteps(index,builder.build());
    }
