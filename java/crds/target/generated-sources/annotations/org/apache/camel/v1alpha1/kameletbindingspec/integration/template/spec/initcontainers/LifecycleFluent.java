...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PreStopBuilder;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PostStart;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PreStopFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PreStop;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PostStartFluent;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.PostStartBuilder;
...
public class LifecycleFluent<A extends LifecycleFluent<A>> extends BaseFluent<A>{
  ...
  public PostStartNested<A> editInitcontainersPostStart() {
  ...
  public PreStopNested<A> editInitcontainersPreStop() {
  ...
  public class PostStartNested<N> extends PostStartFluent<PostStartNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersPostStart() {
      return and();
    }
  ...
  public class PreStopNested<N> extends PreStopFluent<PreStopNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersPreStop() {
      return and();
    }
