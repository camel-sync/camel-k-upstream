...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ReadinessProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevices;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicyFluent;
import java.util.ArrayList;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicy;
import java.util.function.Predicate;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.StartupProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResourcesBuilder;
import java.lang.Boolean;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.LivenessProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Lifecycle;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMountsFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ReadinessProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.LifecycleBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ReadinessProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevicesBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.StartupProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFromBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.LivenessProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.SecurityContextFluent;
import java.util.Collection;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResourcesFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Resources;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevicesFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Env;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.PortsBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMountsBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.StartupProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMounts;
import java.util.Iterator;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicyBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Ports;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.LivenessProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.LifecycleFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFrom;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.PortsFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFromFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.SecurityContext;

/**
 * Generated
 */
@SuppressWarnings("unchecked")
public class EphemeralContainersFluent<A extends EphemeralContainersFluent<A>> extends BaseFluent<A>{
  public EphemeralContainersFluent() {
  }
  
  public EphemeralContainersFluent(EphemeralContainers instance) {
  ...
  protected void copyInstance(EphemeralContainers instance) {
    instance = (instance != null ? instance : new EphemeralContainers());
    if (instance != null) {
  ...
  public A addToEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A addAllToEphemeralcontainersEnv(Collection<Env> items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").add(builder);this.env.add(builder);} return (A)this;
  }
  
  public A removeFromEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Env... items) {
  ...
  public A removeAllFromEphemeralcontainersEnv(Collection<Env> items) {
    if (this.env == null) return (A)this;
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").remove(builder); this.env.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersEnv(Predicate<EnvBuilder> predicate) {
  ...
  public A withEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Env... env) {
    if (this.env != null) {
        this.env.clear();
  ...
  public A addToEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFrom... items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
  ...
  public A addAllToEphemeralcontainersEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").add(builder);this.envFrom.add(builder);} return (A)this;
  }
  
  public A removeFromEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFrom... items) {
  ...
  public A removeAllFromEphemeralcontainersEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) return (A)this;
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").remove(builder); this.envFrom.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersEnvFrom(Predicate<EnvFromBuilder> predicate) {
  ...
  public A withEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.EnvFrom... envFrom) {
    if (this.envFrom != null) {
        this.envFrom.clear();
  ...
  public LivenessProbeNested<A> editEphemeralcontainersLivenessProbe() {
  ...
  public A addToPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Ports... items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
  ...
  public A addAllToEphemeralcontainersPorts(Collection<Ports> items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  
  public A removeFromPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Ports... items) {
  ...
  public A removeAllFromEphemeralcontainersPorts(Collection<Ports> items) {
    if (this.ports == null) return (A)this;
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").remove(builder); this.ports.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersPorts(Predicate<PortsBuilder> predicate) {
  ...
  public A withPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.Ports... ports) {
    if (this.ports != null) {
        this.ports.clear();
  ...
  public ReadinessProbeNested<A> editEphemeralcontainersReadinessProbe() {
  ...
  public A addToResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicy... items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
  ...
  public A addAllToEphemeralcontainersResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").add(builder);this.resizePolicy.add(builder);} return (A)this;
  }
  
  public A removeFromResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicy... items) {
  ...
  public A removeAllFromEphemeralcontainersResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) return (A)this;
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").remove(builder); this.resizePolicy.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersResizePolicy(Predicate<ResizePolicyBuilder> predicate) {
  ...
  public A withResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.ResizePolicy... resizePolicy) {
    if (this.resizePolicy != null) {
  ...
  public ResourcesNested<A> editEphemeralcontainersResources() {
  ...
  public StartupProbeNested<A> editEphemeralcontainersStartupProbe() {
  ...
  public A addToVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevices... items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
  ...
  public A addAllToEphemeralcontainersVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").add(builder);this.volumeDevices.add(builder);} return (A)this;
  }
  
  public A removeFromVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevices... items) {
  ...
  public A removeAllFromEphemeralcontainersVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) return (A)this;
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").remove(builder); this.volumeDevices.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersVolumeDevices(Predicate<VolumeDevicesBuilder> predicate) {
  ...
  public A withVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeDevices... volumeDevices) {
    if (this.volumeDevices != null) {
  ...
  public A addToVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMounts... items) {
    if (this.volumeMounts == null) {this.volumeMounts = new ArrayList<VolumeMountsBuilder>();}
  ...
  public A addAllToEphemeralcontainersVolumeMounts(Collection<VolumeMounts> items) {
    if (this.volumeMounts == null) {this.volumeMounts = new ArrayList<VolumeMountsBuilder>();}
    for (VolumeMounts item : items) {VolumeMountsBuilder builder = new VolumeMountsBuilder(item);_visitables.get("volumeMounts").add(builder);this.volumeMounts.add(builder);} return (A)this;
  }
  
  public A removeFromVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMounts... items) {
  ...
  public A removeAllFromEphemeralcontainersVolumeMounts(Collection<VolumeMounts> items) {
    if (this.volumeMounts == null) return (A)this;
    for (VolumeMounts item : items) {VolumeMountsBuilder builder = new VolumeMountsBuilder(item);_visitables.get("volumeMounts").remove(builder); this.volumeMounts.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromEphemeralcontainersVolumeMounts(Predicate<VolumeMountsBuilder> predicate) {
  ...
  public A withVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.ephemeralcontainers.VolumeMounts... volumeMounts) {
    if (this.volumeMounts != null) {
  ...
  public boolean equals(Object o) {
    ...
    EphemeralContainersFluent that = (EphemeralContainersFluent) o;
  ...
  public class EnvNested<N> extends EnvFluent<EnvNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToEnv(index,builder.build());
    }
    
    public N endEphemeralcontainersEnv() {
      return and();
    }
  ...
  public class EnvFromNested<N> extends EnvFromFluent<EnvFromNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToEnvFrom(index,builder.build());
    }
    
    public N endEphemeralcontainersEnvFrom() {
      return and();
    }
  ...
  public class LifecycleNested<N> extends LifecycleFluent<LifecycleNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withLifecycle(builder.build());
    }
  ...
  public class LivenessProbeNested<N> extends LivenessProbeFluent<LivenessProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withLivenessProbe(builder.build());
    }
    
    public N endEphemeralcontainersLivenessProbe() {
      return and();
    }
  ...
  public class PortsNested<N> extends PortsFluent<PortsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToPorts(index,builder.build());
    }
    
    public N endEphemeralcontainersPort() {
      return and();
    }
  ...
  public class ReadinessProbeNested<N> extends ReadinessProbeFluent<ReadinessProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withReadinessProbe(builder.build());
    }
    
    public N endEphemeralcontainersReadinessProbe() {
      return and();
    }
  ...
  public class ResizePolicyNested<N> extends ResizePolicyFluent<ResizePolicyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToResizePolicy(index,builder.build());
    }
    
    public N endEphemeralcontainersResizePolicy() {
      return and();
    }
  ...
  public class ResourcesNested<N> extends ResourcesFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withResources(builder.build());
    }
    
    public N endEphemeralcontainersResources() {
      return and();
    }
  ...
  public class SecurityContextNested<N> extends SecurityContextFluent<SecurityContextNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withSecurityContext(builder.build());
    }
  ...
  public class StartupProbeNested<N> extends StartupProbeFluent<StartupProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.withStartupProbe(builder.build());
    }
    
    public N endEphemeralcontainersStartupProbe() {
      return and();
    }
  ...
  public class VolumeDevicesNested<N> extends VolumeDevicesFluent<VolumeDevicesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToVolumeDevices(index,builder.build());
    }
    
    public N endEphemeralcontainersVolumeDevice() {
      return and();
    }
  ...
  public class VolumeMountsNested<N> extends VolumeMountsFluent<VolumeMountsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) EphemeralContainersFluent.this.setToVolumeMounts(index,builder.build());
    }
    
    public N endEphemeralcontainersVolumeMount() {
      return and();
    }
