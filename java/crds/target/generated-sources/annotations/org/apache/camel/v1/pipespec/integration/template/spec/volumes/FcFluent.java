...
public class FcFluent<A extends FcFluent<A>> extends BaseFluent<A>{
  public FcFluent() {
  }
  
  public FcFluent(Fc instance) {
  ...
  protected void copyInstance(Fc instance) {
