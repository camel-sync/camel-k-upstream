...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.traits.keda.ConfigurationBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.traits.keda.Configuration;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.Object;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.traits.keda.ConfigurationFluent;

/**
 * Generated
 */
@SuppressWarnings("unchecked")
public class KedaFluent<A extends KedaFluent<A>> extends BaseFluent<A>{
  public KedaFluent() {
  }
  
  public KedaFluent(Keda instance) {
    this.copyInstance(instance);
  }
  private ConfigurationBuilder configuration;
  
  protected void copyInstance(Keda instance) {
    instance = (instance != null ? instance : new Keda());
    if (instance != null) {
  ...
  public class ConfigurationNested<N> extends ConfigurationFluent<ConfigurationNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) KedaFluent.this.withConfiguration(builder.build());
    }
