...
public class QuarkusFluent<A extends QuarkusFluent<A>> extends BaseFluent<A>{
  ...
  public A addToBuildMode(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.BuildMode... items) {
    if (this.buildMode == null) {this.buildMode = new ArrayList<Quarkus.BuildMode>();}
  ...
  public A removeFromBuildMode(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.BuildMode... items) {
  ...
  public A withBuildMode(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.BuildMode... buildMode) {
  ...
  public A addToPackageTypes(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.PackageTypes... items) {
    if (this.packageTypes == null) {this.packageTypes = new ArrayList<Quarkus.PackageTypes>();}
  ...
  public A removeFromPackageTypes(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.PackageTypes... items) {
  ...
  public A withPackageTypes(org.apache.camel.v1.integrationplatformspec.traits.Quarkus.PackageTypes... packageTypes) {
