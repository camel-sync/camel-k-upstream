...
public class ConditionsFluent<A extends ConditionsFluent<A>> extends BaseFluent<A>{
  ...
  public A addToPods(org.apache.camel.v1.pipestatus.conditions.Pods... items) {
    if (this.pods == null) {this.pods = new ArrayList<PodsBuilder>();}
  ...
  public A removeFromPods(org.apache.camel.v1.pipestatus.conditions.Pods... items) {
  ...
  public A withPods(org.apache.camel.v1.pipestatus.conditions.Pods... pods) {
    if (this.pods != null) {
        this.pods.clear();
