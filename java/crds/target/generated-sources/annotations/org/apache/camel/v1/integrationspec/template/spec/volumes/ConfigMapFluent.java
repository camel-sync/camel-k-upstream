...
import org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.ItemsBuilder;
...
import org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.ItemsFluent;
...
public class ConfigMapFluent<A extends ConfigMapFluent<A>> extends BaseFluent<A>{
  ...
  public A addToItems(org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items... items) {
    if (this.items == null) {this.items = new ArrayList<ItemsBuilder>();}
  ...
  public A removeFromItems(org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items... items) {
  ...
  public A withItems(org.apache.camel.v1.integrationspec.template.spec.volumes.configmap.Items... items) {
    if (this.items != null) {
        this.items.clear();
