...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.HttpGetBuilder;
import java.lang.SuppressWarnings;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.HttpGet;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.ExecBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.TcpSocketBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.TcpSocketFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.Exec;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.HttpGetFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.ExecFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.lifecycle.poststart.TcpSocket;
...
public class PostStartFluent<A extends PostStartFluent<A>> extends BaseFluent<A>{
  ...
  public ExecNested<A> editInitcontainersExec() {
  ...
  public HttpGetNested<A> editInitcontainersHttpGet() {
  ...
  public TcpSocketNested<A> editInitcontainersTcpSocket() {
  ...
  public class ExecNested<N> extends ExecFluent<ExecNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersExec() {
      return and();
    }
  ...
  public class HttpGetNested<N> extends HttpGetFluent<HttpGetNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersHttpGet() {
      return and();
    }
  ...
  public class TcpSocketNested<N> extends TcpSocketFluent<TcpSocketNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersTcpSocket() {
      return and();
    }
