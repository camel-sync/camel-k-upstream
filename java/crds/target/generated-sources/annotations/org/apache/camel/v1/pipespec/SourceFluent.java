...
public class SourceFluent<A extends SourceFluent<A>> extends BaseFluent<A>{
  ...
  public RefNested<A> editSourceRef() {
  ...
  public class PropertiesNested<N> extends PropertiesFluent<PropertiesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SourceFluent.this.withProperties(builder.build());
    }
  ...
  public class RefNested<N> extends RefFluent<RefNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) SourceFluent.this.withRef(builder.build());
    }
