...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.HttpGetBuilder;
import java.lang.SuppressWarnings;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.HttpGet;
import io.fabric8.kubernetes.api.builder.Nested;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.ExecBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.TcpSocketBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.TcpSocketFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.Exec;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.HttpGetFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.ExecFluent;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.lifecycle.poststart.TcpSocket;
...
public class PostStartFluent<A extends PostStartFluent<A>> extends BaseFluent<A>{
  ...
  public ExecNested<A> editIntegrationExec() {
  ...
  public HttpGetNested<A> editIntegrationHttpGet() {
  ...
  public TcpSocketNested<A> editIntegrationTcpSocket() {
  ...
  public class HttpGetNested<N> extends HttpGetFluent<HttpGetNested<N>> implements Nested<N>{
    ...
    public N endIntegrationHttpGet() {
      return and();
    }
  ...
  public class TcpSocketNested<N> extends TcpSocketFluent<TcpSocketNested<N>> implements Nested<N>{
    ...
    public N endIntegrationTcpSocket() {
      return and();
    }
