...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.env.ValueFrom;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.env.ValueFromBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.initcontainers.env.ValueFromFluent;
...
public class EnvFluent<A extends EnvFluent<A>> extends BaseFluent<A>{
  ...
  public ValueFromNested<A> editInitcontainersValueFrom() {
  ...
  public class ValueFromNested<N> extends ValueFromFluent<ValueFromNested<N>> implements Nested<N>{
    ...
    public N endInitcontainersValueFrom() {
      return and();
    }
