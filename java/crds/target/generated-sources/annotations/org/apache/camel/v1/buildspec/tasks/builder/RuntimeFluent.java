...
public class RuntimeFluent<A extends RuntimeFluent<A>> extends BaseFluent<A>{
  ...
  public A addToDependencies(org.apache.camel.v1.buildspec.tasks.builder.runtime.Dependencies... items) {
    if (this.dependencies == null) {this.dependencies = new ArrayList<DependenciesBuilder>();}
  ...
  public A removeFromDependencies(org.apache.camel.v1.buildspec.tasks.builder.runtime.Dependencies... items) {
  ...
  public A withDependencies(org.apache.camel.v1.buildspec.tasks.builder.runtime.Dependencies... dependencies) {
    if (this.dependencies != null) {
