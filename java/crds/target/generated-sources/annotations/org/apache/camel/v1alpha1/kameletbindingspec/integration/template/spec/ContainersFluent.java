...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ReadinessProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevices;
import io.fabric8.kubernetes.api.builder.VisitableBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicyFluent;
import java.util.ArrayList;
import java.lang.String;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicy;
import java.util.function.Predicate;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.SecurityContextBuilder;
import io.fabric8.kubernetes.api.builder.BaseFluent;
import java.util.List;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.StartupProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResourcesBuilder;
import java.lang.Boolean;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.LivenessProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Lifecycle;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMountsFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ReadinessProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.LifecycleBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ReadinessProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevicesBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.StartupProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFromBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.LivenessProbeFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.SecurityContextFluent;
import java.util.Collection;
import java.lang.Object;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResourcesFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Resources;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevicesFluent;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Env;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.PortsBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMountsBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.StartupProbe;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMounts;
import java.util.Iterator;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicyBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Ports;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.LivenessProbeBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.LifecycleFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvBuilder;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFrom;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.PortsFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFromFluent;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.SecurityContext;
...
public class ContainersFluent<A extends ContainersFluent<A>> extends BaseFluent<A>{
  ...
  public ContainersFluent(Containers instance) {
  ...
  protected void copyInstance(Containers instance) {
    instance = (instance != null ? instance : new Containers());
    if (instance != null) {
  ...
  public A addToEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Env... items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
  ...
  public A addAllToIntegrationEnv(Collection<Env> items) {
    if (this.env == null) {this.env = new ArrayList<EnvBuilder>();}
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").add(builder);this.env.add(builder);} return (A)this;
  }
  
  public A removeFromEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Env... items) {
  ...
  public A removeAllFromIntegrationEnv(Collection<Env> items) {
    if (this.env == null) return (A)this;
    for (Env item : items) {EnvBuilder builder = new EnvBuilder(item);_visitables.get("env").remove(builder); this.env.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationEnv(Predicate<EnvBuilder> predicate) {
  ...
  public A withEnv(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Env... env) {
    if (this.env != null) {
        this.env.clear();
  ...
  public A addToEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFrom... items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
  ...
  public A addAllToIntegrationEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) {this.envFrom = new ArrayList<EnvFromBuilder>();}
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").add(builder);this.envFrom.add(builder);} return (A)this;
  }
  
  public A removeFromEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFrom... items) {
  ...
  public A removeAllFromIntegrationEnvFrom(Collection<EnvFrom> items) {
    if (this.envFrom == null) return (A)this;
    for (EnvFrom item : items) {EnvFromBuilder builder = new EnvFromBuilder(item);_visitables.get("envFrom").remove(builder); this.envFrom.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationEnvFrom(Predicate<EnvFromBuilder> predicate) {
  ...
  public A withEnvFrom(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.EnvFrom... envFrom) {
    if (this.envFrom != null) {
        this.envFrom.clear();
  ...
  public LivenessProbeNested<A> editIntegrationLivenessProbe() {
  ...
  public A addToPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Ports... items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
  ...
  public A addAllToIntegrationPorts(Collection<Ports> items) {
    if (this.ports == null) {this.ports = new ArrayList<PortsBuilder>();}
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").add(builder);this.ports.add(builder);} return (A)this;
  }
  
  public A removeFromPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Ports... items) {
  ...
  public A removeAllFromIntegrationPorts(Collection<Ports> items) {
    if (this.ports == null) return (A)this;
    for (Ports item : items) {PortsBuilder builder = new PortsBuilder(item);_visitables.get("ports").remove(builder); this.ports.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationPorts(Predicate<PortsBuilder> predicate) {
  ...
  public A withPorts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.Ports... ports) {
    if (this.ports != null) {
        this.ports.clear();
  ...
  public ReadinessProbeNested<A> editIntegrationReadinessProbe() {
  ...
  public A addToResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicy... items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
  ...
  public A addAllToIntegrationResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) {this.resizePolicy = new ArrayList<ResizePolicyBuilder>();}
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").add(builder);this.resizePolicy.add(builder);} return (A)this;
  }
  
  public A removeFromResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicy... items) {
  ...
  public A removeAllFromIntegrationResizePolicy(Collection<ResizePolicy> items) {
    if (this.resizePolicy == null) return (A)this;
    for (ResizePolicy item : items) {ResizePolicyBuilder builder = new ResizePolicyBuilder(item);_visitables.get("resizePolicy").remove(builder); this.resizePolicy.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationResizePolicy(Predicate<ResizePolicyBuilder> predicate) {
  ...
  public A withResizePolicy(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.ResizePolicy... resizePolicy) {
    if (this.resizePolicy != null) {
  ...
  public ResourcesNested<A> editIntegrationResources() {
  ...
  public StartupProbeNested<A> editIntegrationStartupProbe() {
  ...
  public A addToVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevices... items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
  ...
  public A addAllToIntegrationVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) {this.volumeDevices = new ArrayList<VolumeDevicesBuilder>();}
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").add(builder);this.volumeDevices.add(builder);} return (A)this;
  }
  
  public A removeFromVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevices... items) {
  ...
  public A removeAllFromIntegrationVolumeDevices(Collection<VolumeDevices> items) {
    if (this.volumeDevices == null) return (A)this;
    for (VolumeDevices item : items) {VolumeDevicesBuilder builder = new VolumeDevicesBuilder(item);_visitables.get("volumeDevices").remove(builder); this.volumeDevices.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationVolumeDevices(Predicate<VolumeDevicesBuilder> predicate) {
  ...
  public A withVolumeDevices(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeDevices... volumeDevices) {
    if (this.volumeDevices != null) {
  ...
  public A addToVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMounts... items) {
    if (this.volumeMounts == null) {this.volumeMounts = new ArrayList<VolumeMountsBuilder>();}
  ...
  public A addAllToIntegrationVolumeMounts(Collection<VolumeMounts> items) {
    if (this.volumeMounts == null) {this.volumeMounts = new ArrayList<VolumeMountsBuilder>();}
    for (VolumeMounts item : items) {VolumeMountsBuilder builder = new VolumeMountsBuilder(item);_visitables.get("volumeMounts").add(builder);this.volumeMounts.add(builder);} return (A)this;
  }
  
  public A removeFromVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMounts... items) {
  ...
  public A removeAllFromIntegrationVolumeMounts(Collection<VolumeMounts> items) {
    if (this.volumeMounts == null) return (A)this;
    for (VolumeMounts item : items) {VolumeMountsBuilder builder = new VolumeMountsBuilder(item);_visitables.get("volumeMounts").remove(builder); this.volumeMounts.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationVolumeMounts(Predicate<VolumeMountsBuilder> predicate) {
  ...
  public A withVolumeMounts(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.containers.VolumeMounts... volumeMounts) {
    if (this.volumeMounts != null) {
  ...
  public boolean equals(Object o) {
    ...
    ContainersFluent that = (ContainersFluent) o;
  ...
  public class EnvNested<N> extends EnvFluent<EnvNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToEnv(index,builder.build());
    }
    
    public N endIntegrationEnv() {
      return and();
    }
  ...
  public class EnvFromNested<N> extends EnvFromFluent<EnvFromNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToEnvFrom(index,builder.build());
    }
    
    public N endIntegrationEnvFrom() {
      return and();
    }
  ...
  public class LifecycleNested<N> extends LifecycleFluent<LifecycleNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withLifecycle(builder.build());
    }
  ...
  public class LivenessProbeNested<N> extends LivenessProbeFluent<LivenessProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withLivenessProbe(builder.build());
    }
    
    public N endIntegrationLivenessProbe() {
      return and();
    }
  ...
  public class PortsNested<N> extends PortsFluent<PortsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToPorts(index,builder.build());
    }
    
    public N endIntegrationPort() {
      return and();
    }
  ...
  public class ReadinessProbeNested<N> extends ReadinessProbeFluent<ReadinessProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withReadinessProbe(builder.build());
    }
    
    public N endIntegrationReadinessProbe() {
      return and();
    }
  ...
  public class ResizePolicyNested<N> extends ResizePolicyFluent<ResizePolicyNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToResizePolicy(index,builder.build());
    }
    
    public N endIntegrationResizePolicy() {
      return and();
    }
  ...
  public class ResourcesNested<N> extends ResourcesFluent<ResourcesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withResources(builder.build());
    }
    
    public N endIntegrationResources() {
      return and();
    }
  ...
  public class SecurityContextNested<N> extends SecurityContextFluent<SecurityContextNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withSecurityContext(builder.build());
    }
  ...
  public class StartupProbeNested<N> extends StartupProbeFluent<StartupProbeNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.withStartupProbe(builder.build());
    }
    
    public N endIntegrationStartupProbe() {
      return and();
    }
  ...
  public class VolumeDevicesNested<N> extends VolumeDevicesFluent<VolumeDevicesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToVolumeDevices(index,builder.build());
    }
    
    public N endIntegrationVolumeDevice() {
      return and();
    }
  ...
  public class VolumeMountsNested<N> extends VolumeMountsFluent<VolumeMountsNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ContainersFluent.this.setToVolumeMounts(index,builder.build());
    }
    
    public N endIntegrationVolumeMount() {
      return and();
    }
