...
public class ProducerFluent<A extends ProducerFluent<A>> extends BaseFluent<A>{
  ...
  protected void copyInstance(Producer instance) {
    instance = (instance != null ? instance : new Producer());
    if (instance != null) {
  ...
  public A addToDependencies(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.Dependencies... items) {
    if (this.dependencies == null) {this.dependencies = new ArrayList<DependenciesBuilder>();}
  ...
  public A removeFromDependencies(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.Dependencies... items) {
  ...
  public A withDependencies(org.apache.camel.v1.camelcatalogspec.artifacts.schemes.producer.Dependencies... dependencies) {
    if (this.dependencies != null) {
  ...
  public boolean equals(Object o) {
    ...
    ProducerFluent that = (ProducerFluent) o;
  ...
  public class DependenciesNested<N> extends DependenciesFluent<DependenciesNested<N>> implements Nested<N>{
    ...
    public N and() {
      return (N) ProducerFluent.this.setToDependencies(index,builder.build());
    }
