...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressionsBuilder;
...
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressions;
import org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressionsFluent;
...
public class LabelSelectorFluent<A extends LabelSelectorFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A addAllToIntegrationMatchExpressions(Collection<MatchExpressions> items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
    for (MatchExpressions item : items) {MatchExpressionsBuilder builder = new MatchExpressionsBuilder(item);_visitables.get("matchExpressions").add(builder);this.matchExpressions.add(builder);} return (A)this;
  }
  
  public A removeFromMatchExpressions(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... items) {
  ...
  public A removeAllFromIntegrationMatchExpressions(Collection<MatchExpressions> items) {
    if (this.matchExpressions == null) return (A)this;
    for (MatchExpressions item : items) {MatchExpressionsBuilder builder = new MatchExpressionsBuilder(item);_visitables.get("matchExpressions").remove(builder); this.matchExpressions.remove(builder);} return (A)this;
  }
  
  public A removeMatchingFromIntegrationMatchExpressions(Predicate<MatchExpressionsBuilder> predicate) {
  ...
  public A withMatchExpressions(org.apache.camel.v1alpha1.kameletbindingspec.integration.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
  ...
  public class MatchExpressionsNested<N> extends MatchExpressionsFluent<MatchExpressionsNested<N>> implements Nested<N>{
    ...
    public N endIntegrationMatchExpression() {
      return and();
    }
