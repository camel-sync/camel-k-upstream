...
import org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.Claims;
import io.fabric8.kubernetes.api.model.IntOrString;
import java.lang.SuppressWarnings;
import io.fabric8.kubernetes.api.builder.Nested;
import java.util.ArrayList;
import java.lang.String;
import org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.ClaimsBuilder;
import java.util.LinkedHashMap;
import java.util.function.Predicate;
import org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.ClaimsFluent;
...
public class ResourcesFluent<A extends ResourcesFluent<A>> extends BaseFluent<A>{
  ...
  public A addToClaims(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.Claims... items) {
    if (this.claims == null) {this.claims = new ArrayList<ClaimsBuilder>();}
  ...
  public A removeFromClaims(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.Claims... items) {
  ...
  public A withClaims(org.apache.camel.v1.integrationspec.template.spec.ephemeralcontainers.resources.Claims... claims) {
    if (this.claims != null) {
        this.claims.clear();
