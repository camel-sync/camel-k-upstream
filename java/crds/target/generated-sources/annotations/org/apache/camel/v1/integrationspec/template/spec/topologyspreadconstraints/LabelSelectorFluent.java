...
public class LabelSelectorFluent<A extends LabelSelectorFluent<A>> extends BaseFluent<A>{
  ...
  public A addToMatchExpressions(org.apache.camel.v1.integrationspec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... items) {
    if (this.matchExpressions == null) {this.matchExpressions = new ArrayList<MatchExpressionsBuilder>();}
  ...
  public A removeFromMatchExpressions(org.apache.camel.v1.integrationspec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... items) {
  ...
  public A withMatchExpressions(org.apache.camel.v1.integrationspec.template.spec.topologyspreadconstraints.labelselector.MatchExpressions... matchExpressions) {
    if (this.matchExpressions != null) {
